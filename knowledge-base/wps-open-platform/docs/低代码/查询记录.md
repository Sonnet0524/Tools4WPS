...
查询低代码应用下指定数据表的某条记录数据

## 请求说明

| **请求地址** | **https://openapi.wps.cn/v7/low_code_app/app_instance/{app_instance_id}/table/{table_id}/records/{record_id}**         |
| :----------- | :--------------------------------------------------------------------------------------------------------------------- |
| **请求方法** | GET                                                                                                                    |
...
```
[GET] https://openapi.wps.cn/v7/low_code_app/app_instance/{app_instance_id}/table/{table_id}/records/{record_id}
```
