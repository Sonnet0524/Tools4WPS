...
| **请求地址** | **https://openapi.wps.cn/v7/low_code_app/app_instance/{app_instance_id}/table/{table_id}/records/create** |
| :----------- | :-------------------------------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                                      |
...
| **名称**      | **参数类型** | **是否必填** | **说明**                                                      |
| :------------ | :----------- | :----------- | :------------------------------------------------------------ |
| create_record | object       | 是           | 创建记录集合                                                  |
| ∟ row_data   | object       | 是           | 记录数据对象，格式为 `field_id:field_value` |

## 请求地址示例

```
[POST] https://openapi.wps.cn/v7/low_code_app/app_instance/{app_instance_id}/table/{table_id}/records/create
```
