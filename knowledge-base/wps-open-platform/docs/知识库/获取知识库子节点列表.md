...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/wiki/spaces/{space_id}/files/{file_id}/children          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `GET`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 获取知识库子节点列表 |
...
| <div style="white-space: nowrap;">file_id</div> | `string` | 是 | 文件夹id | - 
