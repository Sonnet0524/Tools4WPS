...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/devhub/apps/{app_id}/chats/cancel          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 取消对话 |
...
<OpenapiRenderTable  dataSource='[{"key":"chat_id","name":"chat_id","deprecated":false,"type":"string","required":"否","enum":[],"xEnum":[],"description":"<p>对话id</p>\n","children":[]}]' />
