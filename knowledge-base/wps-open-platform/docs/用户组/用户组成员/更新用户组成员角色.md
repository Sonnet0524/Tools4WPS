...
| **请求地址** | **https://openapi.wps.cn/v7/groups/{group_id}/members/update_role**                 |
|:---------|:------------------------------------------------------------------------------------|
| **请求方法** | POST                                                                                |
...
| role      | string[enum] | 是        | 组成员角色<br/>`normal`：普通成员；`admin`：管理员；`owner`：拥有者 |

## 请求地址示例

```
[POST] https://openapi.wps.cn/v7/groups/{group_id}/members/update_role
```
