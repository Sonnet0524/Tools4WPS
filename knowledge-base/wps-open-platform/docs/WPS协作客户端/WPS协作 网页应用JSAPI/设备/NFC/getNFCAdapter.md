...
| 名称          | 类型     | 描述         |
|---------------|----------|--------------|
| getNfcA | `Function` | 获取NfcA实例，实例支持NFC-A (ISO 14443-3A)标准的读写 |
| offNfcDiscovered | `Function` | 取消监听 NFC Tag |
| onNfcDiscovered | `Function` | 监听 NFC Tag |
| startNfcDiscovery | `Function` | 开始扫描 NFC 标签 |
| stopNfcDiscovery | `Function` | 关闭 NFC 标签扫描 |
## 示例代码
```ts
