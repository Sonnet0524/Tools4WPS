...
| **请求地址** | **https://openapi.wps.cn/v7/store/allocations/batch_create**                                                                                                                          |
| :----------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **请求方法** | POST                                                                                                                                                                                  |
...
| entity_ids      | array[string] | 是           | 被分配的对象实体 id 集合                                  |
| entity_type     | string[enum]  | 是           | 被分配对象实体类型  <br/>`user`：用户；`app`：应用；`company`：企业 |
