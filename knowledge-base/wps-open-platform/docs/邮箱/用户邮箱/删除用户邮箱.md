...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/user_mailboxes/{user_id}/delete          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 清除指定成员的所有用户邮箱，包括主邮箱和别名邮箱。支持ex_user_id和user_id，需要在请求头中标明X-Kso-Id-Type使用 internal或external，默认是internal |
