...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/user_mailboxes/{user_id}/delete_alias          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 删除指定成员的指定邮箱别名。支持ex_user_id和user_id，需要在请求头中标明X-Kso-Id-Type使用 internal或external，默认是internal |
