...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/todo/personal_tasks/batch_delete          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 删除个人待办 |
...
<OpenapiRenderTable  dataSource='[{"key":"ids","name":"ids","deprecated":false,"type":"array[string]","required":"是","enum":[],"xEnum":[],"description":"<p>待办ID列表，单次请求最多支持删除20个待办</p>\n","children":[]}]' />
