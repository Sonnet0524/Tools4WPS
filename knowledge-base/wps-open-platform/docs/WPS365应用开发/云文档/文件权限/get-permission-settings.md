---
title: Access File Permission Settings
breadcrumb: WPS365应用开发 > 云文档 > 文件权限 > 获取文件权限配置项
source: raw_md/app-integration-dev/wps365/server/yundoc/file-permission/get-permission-settings.md
---
