---
title: Batch License for Drives
breadcrumb: WPS365应用开发 > 云文档 > 文件权限 > 盘批量授权
source: raw_md/app-integration-dev/wps365/server/yundoc/file-permission/batch-create-drive-permissions.md
---
