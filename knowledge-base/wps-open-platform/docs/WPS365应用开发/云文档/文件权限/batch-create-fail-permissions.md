---
title: Bulk Authorization (Single File)
breadcrumb: WPS365应用开发 > 云文档 > 文件权限 > 批量授权（单个文件）
source: raw_md/app-integration-dev/wps365/server/yundoc/file-permission/batch-create-fail-permissions.md
---
