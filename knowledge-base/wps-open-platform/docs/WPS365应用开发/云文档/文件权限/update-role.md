---
title: Update Document Permission Roles
breadcrumb: WPS365应用开发 > 云文档 > 文件权限 > 更新文档权限角色
source: raw_md/app-integration-dev/wps365/server/yundoc/file-permission/update-role.md
---
