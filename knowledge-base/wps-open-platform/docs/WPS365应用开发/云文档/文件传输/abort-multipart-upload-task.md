---
title: Abort Chunk Upload Task
breadcrumb: WPS365应用开发 > 云文档 > 文件传输 > 中止分块上传任务
source: raw_md/app-integration-dev/wps365/server/yundoc/file-transfer/abort-multipart-upload-task.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/multipart_upload_tasks/{upload_id}/abort          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 取消分块上传任务 |
...
| 属性名 | 类型 | 是否必填 | 描述 | 可选值 |
|-------|------|------|-------|-------|
| <div style="white-space: nowrap;">upload_id</div> | `string` | 是 |  | - 
