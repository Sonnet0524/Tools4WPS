---
title: Save As
breadcrumb: WPS365应用开发 > 云文档 > 文件（夹） > 文件另存为
source: raw_md/app-integration-dev/wps365/server/yundoc/file/save-as-file.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/drives/{drive_id}/files/{file_id}/save_as          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 文件另存为 |
...
<OpenapiRenderTable  dataSource='[{"key":"dst_drive_id","name":"dst_drive_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>目标驱动盘id</p>\n","children":[]},{"key":"dst_parent_id","name":"dst_parent_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>目标父目录id</p>\n","children":[]},{"key":"name","name":"name","deprecated":false,"type":"string","required":"否","enum":[],"xEnum":[],"description":"<p>目标文件的新文件名</p>\n","children":[]},{"key":"on_name_conflict","name":"on_name_conflict","deprecated":false,"type":"string","required":"否","enum":["fail","rename","overwrite","replace"],"xEnum":["fail","rename","overwrite","replace"],"description":"<p>新建时文件名冲突行为处理方式(公网目前只支持rename和fail), 默认不传为rename</p>\n","children":[]}]' />
