---
title: Transfer File Owner
breadcrumb: WPS365应用开发 > 云文档 > 文件（夹） > 转让文件拥有者
source: raw_md/app-integration-dev/wps365/server/yundoc/file/transfer-file.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/drives/{drive_id}/files/{file_id}/transfer_owner          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 转让文件拥有者,拥有者是文件创建者 |
...
<OpenapiRenderTable  dataSource='[{"key":"account_id","name":"account_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>接收者账号id</p>\n","children":[]}]' />
