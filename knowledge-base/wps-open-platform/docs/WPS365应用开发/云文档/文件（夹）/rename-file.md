...
breadcrumb: WPS365应用开发 > 云文档 > 文件（夹） > 重命名文件（夹）
source: raw_md/app-integration-dev/wps365/server/yundoc/file/rename-file.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/drives/{drive_id}/files/{file_id}/rename          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 重命名文件（夹） |
...
<OpenapiRenderTable  dataSource='[{"key":"dst_name","name":"dst_name","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>文件名，须带上后缀，例: abc.txt. 支持格式 otl, doc, xls, ppt, wdoc, wxls, wppt, h5, pom, pof, docx, xlsx</p>\n","children":[]}]' />
