---
title: Batch Copy Files (Folders)
breadcrumb: WPS365应用开发 > 云文档 > 文件（夹） > 批量复制文件（夹）
source: raw_md/app-integration-dev/wps365/server/yundoc/file/batch-copy-file.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/drives/{drive_id}/files/batch_copy          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 批量复制文件(夹) |
...
<OpenapiRenderTable  dataSource='[{"key":"dst_drive_id","name":"dst_drive_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"-","children":[]},{"key":"dst_parent_id","name":"dst_parent_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"-","children":[]},{"key":"file_ids","name":"file_ids","deprecated":false,"type":"array[string]","required":"是","enum":[],"xEnum":[],"description":"-","children":[]}]' />
