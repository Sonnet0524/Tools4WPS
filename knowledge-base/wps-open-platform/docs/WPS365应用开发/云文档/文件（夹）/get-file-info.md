...
breadcrumb: WPS365应用开发 > 云文档 > 文件（夹） > 获取文件信息
source: raw_md/app-integration-dev/wps365/server/yundoc/file/get-file-info.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/files/{file_id}/meta          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `GET`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 根据file_id获取文件信息 |
