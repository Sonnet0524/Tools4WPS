---
title: Get file information based on drive_id and file_id
breadcrumb: WPS365应用开发 > 云文档 > 文件（夹） > 根据drive_id和file_id获取文件信息
source: raw_md/app-integration-dev/wps365/server/yundoc/file/get-file-info-by-id.md
---


# 根据drive_id和file_id获取文件信息
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/drives/{drive_id}/files/{file_id}/meta          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `GET`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 根据drive_id和file_id获取文件信息 |
...
| <div style="white-space: nowrap;">with_drive</div> | `boolean` | 否 | 是否返文件所属drive信息 | - 
