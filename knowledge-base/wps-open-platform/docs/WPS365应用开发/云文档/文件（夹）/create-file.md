...
breadcrumb: WPS365应用开发 > 云文档 > 文件（夹） > 新建文件（夹）
source: raw_md/app-integration-dev/wps365/server/yundoc/file/create-file.md
---
