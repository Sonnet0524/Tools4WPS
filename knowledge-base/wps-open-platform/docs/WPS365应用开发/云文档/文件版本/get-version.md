---
title: Get File Version Information
breadcrumb: WPS365应用开发 > 云文档 > 文件版本 > 获取文件版本信息
source: raw_md/app-integration-dev/wps365/server/yundoc/file-version/get-version.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/drives/{drive_id}/files/{file_id}/versions/{version_num}/meta          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `GET`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 获取文件版本信息 |
