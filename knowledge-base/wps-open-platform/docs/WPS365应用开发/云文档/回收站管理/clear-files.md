---
title: Empty Recycle Bin Files
breadcrumb: WPS365应用开发 > 云文档 > 回收站管理 > 清空回收站文件
source: raw_md/app-integration-dev/wps365/server/yundoc/recycle-bin-management/clear-files.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/deleted_files/clear          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 清空回收站文件 |
...
<OpenapiRenderTable  dataSource='[{"key":"drive_id","name":"drive_id","deprecated":false,"type":"string","required":"否","enum":[],"xEnum":[],"description":"-","children":[]}]' />
