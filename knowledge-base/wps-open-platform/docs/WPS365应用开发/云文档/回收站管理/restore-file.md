---
title: Restore Recycle Bin File
breadcrumb: WPS365应用开发 > 云文档 > 回收站管理 > 还原回收站文件
source: raw_md/app-integration-dev/wps365/server/yundoc/recycle-bin-management/restore-file.md
---
