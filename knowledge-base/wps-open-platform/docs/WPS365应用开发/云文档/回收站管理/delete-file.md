---
title: Delete Level 1 Recycle Bin File
breadcrumb: WPS365应用开发 > 云文档 > 回收站管理 > 删除一级回收站文件
source: raw_md/app-integration-dev/wps365/server/yundoc/recycle-bin-management/delete-file.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/deleted_files/{file_id}/delete          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 删除一级回收站文件 |
