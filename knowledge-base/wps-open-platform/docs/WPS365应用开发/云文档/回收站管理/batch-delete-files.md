---
title: Bulk File Deletion in Level 1 Recycle Bin
breadcrumb: WPS365应用开发 > 云文档 > 回收站管理 > 一级回收站批量文件删除
source: raw_md/app-integration-dev/wps365/server/yundoc/recycle-bin-management/batch-delete-files.md
---


# 一级回收站批量文件删除

一级回收站批量文件删除, 删除目的地由 delete_type 参数设置，仅支持指定为下一级 second 或 permanent
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/deleted_files/batch_delete          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 一级回收站批量文件删除, 删除目的地由delete_type参数设置,仅支持指定为下一级second或permanent |
