---
title: Get Sent Share Link List
breadcrumb: WPS365应用开发 > 云文档 > 文件分享 > 获取发送的分享链接列表
source: raw_md/app-integration-dev/wps365/server/yundoc/file-link/get-send-link-list.md
---
