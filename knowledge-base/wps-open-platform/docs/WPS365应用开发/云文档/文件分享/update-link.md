---
title: Modify Share Link Attributes
breadcrumb: WPS365应用开发 > 云文档 > 文件分享 > 修改分享链接属性
source: raw_md/app-integration-dev/wps365/server/yundoc/file-link/update-link.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/links/{link_id}/update          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 修改分享链接属性 |
