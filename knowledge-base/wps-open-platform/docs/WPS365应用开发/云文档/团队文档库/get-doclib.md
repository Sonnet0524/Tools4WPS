---
title: Get Document Library Information
breadcrumb: WPS365应用开发 > 云文档 > 团队文档库 > 获取文档库信息
source: raw_md/app-integration-dev/wps365/server/yundoc/teams-doclib/get-doclib.md
---
