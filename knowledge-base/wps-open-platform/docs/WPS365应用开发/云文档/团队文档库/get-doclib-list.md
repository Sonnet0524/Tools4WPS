---
title: Get Team Document Library List
breadcrumb: WPS365应用开发 > 云文档 > 团队文档库 > 获取团队文档库列表
source: raw_md/app-integration-dev/wps365/server/yundoc/teams-doclib/get-doclib-list.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/doclibs          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `GET`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 获取文档库(团队文档)列表 |
...
| 属性名 | 类型 | 是否必填 | 描述 | 可选值 |
|-------|------|------|-------|-------|
| <div style="white-space: nowrap;">page_size</div> | `integer` | 是 | 分页大小,公网上限是100 | - 
| <div style="white-space: nowrap;">page_token</div> | `string` | 否 | 分页token | - 
| <div style="white-space: nowrap;">user_role</div> | `array` | 否 | 按用户在文档库对应用户组的角色筛选组,按ctime返回,置顶不生效 | `readonly`, `normal`, `admin`, `owner` 
