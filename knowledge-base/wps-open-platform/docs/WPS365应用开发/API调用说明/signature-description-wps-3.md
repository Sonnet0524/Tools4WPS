---
title: Signature Instructions (WPS-3)
breadcrumb: WPS365应用开发 > API调用说明 > 签名说明（WPS-3）
source: raw_md/app-integration-dev/wps365/server/api-description/signature-description-wps-3.md
---
