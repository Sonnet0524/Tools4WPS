---
title: Batch Query Specified Department Information
breadcrumb: WPS365应用开发 > 通讯录 > 部门 > 批量查询指定部门信息
source: raw_md/app-integration-dev/wps365/server/address-book/dept/batch-dept-info.md
---
