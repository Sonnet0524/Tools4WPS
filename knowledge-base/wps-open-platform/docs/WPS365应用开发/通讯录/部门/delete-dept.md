...
breadcrumb: WPS365应用开发 > 通讯录 > 部门 > 删除部门
source: raw_md/app-integration-dev/wps365/server/address-book/dept/delete-dept.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/depts/{dept_id}/delete**                                |
| :----------- | :---------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                |
...
```
[POST] https://openapi.wps.cn/v7/depts/{dept_id}/delete
```
