---
title: Get Department List Under Affiliated Organization
breadcrumb: WPS365应用开发 > 通讯录 > 关联组织 > 获取关联组织下的部门列表
source: raw_md/app-integration-dev/wps365/server/address-book/partners/get-partners-dept-list.md
---

# 获取关联组织下的部门列表

获取用户在当前关联组织下的部门列表;dept_id为0时表示获取企业一级部门

## 请求说明

| **请求地址** | **https://openapi.wps.cn/v7/partners/{partner_id}/depts/{dept_id}/children**                                                                  |
| :----------- |:--------------------------------------------------------------------------------------------------------|
| **请求方法** | GET                                                                                                     |
...
| dept_id  | string      | 关联组织的部门id，查询根部门时传0   |
...
```
[GET] https://openapi.wps.cn/v7/partners/{partner_id}/depts/{dept_id}/children
```
