...
breadcrumb: WPS365应用开发 > 通讯录 > 自定义用户属性 > 删除自定义用户属性
source: raw_md/app-integration-dev/wps365/server/address-book/custom_attr/delete-attr.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/companies/user_custom_attrs/batch_delete**              |
| :----------- | :---------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                |
...
| **名称** | **参数类型**  | **是否必填** | **说明**          |
| :------- | :------------ | :----------- | :---------------- |
| attr_ids | array[string] | 是           | 自定义用户属性 id |

## 请求地址示例

```
[POST] https://openapi.wps.cn/v7/companies/user_custom_attrs/batch_delete
```
