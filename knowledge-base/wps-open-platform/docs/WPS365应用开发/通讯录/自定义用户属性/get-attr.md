---
title: Fetch Custom User Properties
breadcrumb: WPS365应用开发 > 通讯录 > 自定义用户属性 > 获取自定义用户属性
source: raw_md/app-integration-dev/wps365/server/address-book/custom_attr/get-attr.md
---
