---
title: Batch Query Users
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 批量查询用户
source: raw_md/app-integration-dev/wps365/server/address-book/user/batch-get-user.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/users/batch_read**                                                             |
| :----------- | :--------------------------------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                                       |
...
| **名称**  | **参数类型**  | **是否必填** | **说明**                                                                                        |
| :-------- | :------------ | :----------- | :---------------------------------------------------------------------------------------------- |
| status    | array[string] | 是           | 状态，必填。可选值：`active`：正常；`notactive`：未激活；`disabled`：禁用                       |
...
```
[POST] https://openapi.wps.cn/v7/users/batch_read
```
