---
title: Get user by phone number
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 根据手机号获取用户
source: raw_md/app-integration-dev/wps365/server/address-book/user/get-phone-user.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/users/by_phones**                                                              |
| :----------- | :--------------------------------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                                       |
...
```
[POST] https://openapi.wps.cn/v7/users/by_phones
```
