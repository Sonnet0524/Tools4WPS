---
title: Batch Update User's Custom Attribute Values
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 批量更新用户的自定义属性值
source: raw_md/app-integration-dev/wps365/server/address-book/user/batch-update-user-attribute.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/users/custom_attrs/batch_update**                       |
| :----------- | :---------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                |
...
| **名称**             | **参数类型**  | **是否必填** | **说明**         |
|:-------------------| :------------ | :----------- | :--------------- |
| users              | array[object] | 是           |                  |
| ∟ custom_attrs     | array[object] | 是           | 用户自定义属性列表   |
| ∟ ∟ attr_id        | string        | 是           | 自定义属性 id    |
| ∟ ∟ option_key     | string        | 否           | 选项             |
| ∟ ∟ relation_user  | string        | 否           | 关联成员 id      |
| ∟ ∟ text           | string        | 否           | 说明             |
...
```
[POST] https://openapi.wps.cn/v7/users/custom_attrs/batch_update
```
