---
title: Query All Users Under Enterprise
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 查询企业下所有用户
source: raw_md/app-integration-dev/wps365/server/address-book/user/get-all-user.md
---
