---
title: Get User Information by ex_user_id
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 根据ex_user_id获取用户信息
source: raw_md/app-integration-dev/wps365/server/address-book/user/get-ex-user.md
---
