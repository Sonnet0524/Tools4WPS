...
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 根据邮箱获取用户
source: raw_md/app-integration-dev/wps365/server/address-book/user/get-email-user.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/users/by_emails**                                                              |
| :----------- | :--------------------------------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                                       |
...
```
[POST] https://openapi.wps.cn/v7/users/by_emails
```
