---
title: Enable Users in Bulk
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 批量启用用户
source: raw_md/app-integration-dev/wps365/server/address-book/user/batch-enable-user.md
---
...
```
[POST] https://openapi.wps.cn/v7/users/batch_enable
```
