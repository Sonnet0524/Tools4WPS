---
title: Query User List Under Department
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 查询部门下用户列表
source: raw_md/app-integration-dev/wps365/server/address-book/user/get-dept-user.md
---
