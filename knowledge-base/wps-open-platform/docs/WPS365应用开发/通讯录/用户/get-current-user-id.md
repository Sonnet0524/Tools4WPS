---
title: Retrieve user ID information
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 获取用户id信息
source: raw_md/app-integration-dev/wps365/server/address-book/user/get-current-user-id.md
---
