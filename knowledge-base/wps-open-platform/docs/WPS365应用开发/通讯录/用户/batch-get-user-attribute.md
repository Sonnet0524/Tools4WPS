---
title: Retrieve Custom Attribute Values for Users in Bulk
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 批量获取用户的自定义属性值
source: raw_md/app-integration-dev/wps365/server/address-book/user/batch-get-user-attribute.md
---
