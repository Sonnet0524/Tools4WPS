---
title: Batch Disable Users
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 批量禁用用户
source: raw_md/app-integration-dev/wps365/server/address-book/user/batch-disable-user.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/users/batch_disable**                                                                          |
| :----------- |:--------------------------------------------------------------------------------------------------------------------------|
| **请求方法** | POST                                                                                                                      |
...
```
[POST] https://openapi.wps.cn/v7/users/batch_disable
```
