---
title: Update User
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 更新用户
source: raw_md/app-integration-dev/wps365/server/address-book/user/update-user.md
---

# 更新用户

基于 user_id 更新指定用户的属性

## 请求说明

| **请求地址** | **https://openapi.wps.cn/v7/users/{user_id}/update**                                |
| :----------- | :---------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                |
...
```
[POST] https://openapi.wps.cn/v7/users/{user_id}/update
```
