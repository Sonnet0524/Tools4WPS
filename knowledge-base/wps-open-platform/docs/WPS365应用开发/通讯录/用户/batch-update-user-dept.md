---
title: Batch Update User Department
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 批量更新用户所在部门
source: raw_md/app-integration-dev/wps365/server/address-book/user/batch-update-user-dept.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/users/batch_update_dept**                               |
| :----------- | :---------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                |
...
| **名称**            | **参数类型**  | **是否必填** | **说明**     |
| :------------------ | :------------ | :----------- | :----------- |
| user_dept_info_list | array[object] | 是           |              |
| ∟ dept_ids          | array[string] | 是           | 部门 id 列表 |
| ∟ user_id           | string        | 是           | 用户 id      |

## 请求地址示例

```
[POST] https://openapi.wps.cn/v7/users/batch_update_dept
```
