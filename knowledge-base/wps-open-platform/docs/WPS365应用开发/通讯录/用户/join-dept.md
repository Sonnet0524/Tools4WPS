...
breadcrumb: WPS365应用开发 > 通讯录 > 用户 > 将用户加入到部门
source: raw_md/app-integration-dev/wps365/server/address-book/user/join-dept.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/depts/{dept_id}/members/{user_id}/create**              |
| :----------- | :---------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                |
...
```
[POST] https://openapi.wps.cn/v7/depts/{dept_id}/members/{user_id}/create
```
