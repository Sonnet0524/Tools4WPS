---
title: Third-party applications obtain the tenant's access token
breadcrumb: WPS365应用开发 > 认证与授权 > 获取访问凭证 > 三方应用获取租户的access_token
source: raw_md/app-integration-dev/wps365/server/certification-authorization/get-token/isvapp-tenant-access-token.md
---
...
| app_ticket    | string   | 是        | 获取到的 app_ticket，有关 app_ticket 的详细介绍，请参考[通用参数](/app-integration-dev/wps365/server/api-description/noun-description) |
