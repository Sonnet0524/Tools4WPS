---
title: Get access_token for tenant from self-built application
breadcrumb: WPS365应用开发 > 认证与授权 > 获取访问凭证 > 自建应用获取租户的access_token
source: raw_md/app-integration-dev/wps365/server/certification-authorization/get-token/selfapp-tenant-access-token.md
---
