...
breadcrumb: WPS365应用开发 > 认证与授权 > 获取访问凭证 > 刷新用户access_token
source: raw_md/app-integration-dev/wps365/server/certification-authorization/get-token/refresh-user-access-token.md
---
