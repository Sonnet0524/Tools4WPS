---
title: Third-party app retrieves app access token
breadcrumb: WPS365应用开发 > 认证与授权 > 获取访问凭证 > 三方应用获取应用的access_token
source: raw_md/app-integration-dev/wps365/server/certification-authorization/get-token/isvapp-app-access-token.md
---
