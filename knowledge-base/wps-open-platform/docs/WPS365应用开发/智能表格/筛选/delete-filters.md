---
title: Remove Filter
breadcrumb: WPS365应用开发 > 智能表格 > 筛选 > 删除筛选
source: raw_md/app-integration-dev/wps365/server/airsheet/filters/delete-filters.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/airsheet/{file_id}/worksheets/{worksheet_id}/filters/delete          |
