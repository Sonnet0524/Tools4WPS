---
title: Add Regional Permissions
breadcrumb: WPS365应用开发 > 传统表格 > 区域权限 > 添加区域权限
source: raw_md/app-integration-dev/wps365/server/sheets/protection/add-protection.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/sheets/{file_id}/protection_ranges          |
