---
title: Delete Sheet
breadcrumb: WPS365应用开发 > 传统表格 > 工作表 > 删除工作表
source: raw_md/app-integration-dev/wps365/server/sheets/worksheets/delete-worksheet.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/sheets/{file_id}/worksheets/batch_delete          |
...
<OpenapiRenderTable  dataSource='[{"key":"worksheet_ids","name":"worksheet_ids","deprecated":false,"type":"array[integer]","required":"否","enum":[],"xEnum":[],"description":"<p>工作表ID列表</p>\n","children":[]}]' />
