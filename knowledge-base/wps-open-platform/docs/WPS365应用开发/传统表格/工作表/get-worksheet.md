---
title: Get Sheet List Information
breadcrumb: WPS365应用开发 > 传统表格 > 工作表 > 获取工作表列表信息
source: raw_md/app-integration-dev/wps365/server/sheets/worksheets/get-worksheet.md
---
