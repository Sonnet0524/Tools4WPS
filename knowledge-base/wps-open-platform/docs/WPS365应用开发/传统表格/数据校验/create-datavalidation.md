---
title: Create Data Validation
breadcrumb: WPS365应用开发 > 传统表格 > 数据校验 > 创建数据校验
source: raw_md/app-integration-dev/wps365/server/sheets/datavalidation/create-datavalidation.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/sheets/{file_id}/worksheets/{worksheet_id}/data_validations          |
