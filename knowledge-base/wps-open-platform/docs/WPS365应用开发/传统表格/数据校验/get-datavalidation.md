---
title: Get Data Validation
breadcrumb: WPS365应用开发 > 传统表格 > 数据校验 > 获取数据校验
source: raw_md/app-integration-dev/wps365/server/sheets/datavalidation/get-datavalidation.md
---
