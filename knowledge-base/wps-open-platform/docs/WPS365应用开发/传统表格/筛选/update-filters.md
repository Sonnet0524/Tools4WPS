---
title: Modify Filter
breadcrumb: WPS365应用开发 > 传统表格 > 筛选 > 修改筛选
source: raw_md/app-integration-dev/wps365/server/sheets/filters/update-filters.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/sheets/{file_id}/worksheets/{worksheet_id}/filters/update          |
