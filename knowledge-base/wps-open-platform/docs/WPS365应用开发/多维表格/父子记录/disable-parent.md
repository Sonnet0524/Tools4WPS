---
title: Disable Parent-Child Relationship (Front-End Only)
breadcrumb: WPS365应用开发 > 多维表格 > 父子记录 > 禁用父子关系（仅对前端生效）
source: raw_md/app-integration-dev/wps365/server/dbsheet/parent/disable-parent.md
---
...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/records/parents/disable          |
