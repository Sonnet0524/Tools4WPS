---
title: Check if parent-child relationship is disabled (frontend only)
breadcrumb: WPS365应用开发 > 多维表格 > 父子记录 > 查询父子关系是否禁用（仅对前端生效）
source: raw_md/app-integration-dev/wps365/server/dbsheet/parent/parent-status.md
---
