---
title: Delete Record
breadcrumb: WPS365应用开发 > 多维表格 > 记录 > 删除记录
source: raw_md/app-integration-dev/wps365/server/dbsheet/records/delete-record.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/records/batch_delete** |
| :----------- | :------------------------------------------------------------------------------------------ |
| **请求方法** | POST                                                                                        |
...
| **名称** | **参数类型**  | **是否必填** | **说明** |
| :------- | :------------ | :----------- | :------- |
| records  | array[string] | 是           | 记录 id  |

## 请求地址示例

```
[POST] https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/records/batch_delete
```
