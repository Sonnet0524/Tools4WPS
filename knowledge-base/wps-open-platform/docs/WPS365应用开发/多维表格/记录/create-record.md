---
title: Create Record
breadcrumb: WPS365应用开发 > 多维表格 > 记录 > 创建记录
source: raw_md/app-integration-dev/wps365/server/dbsheet/records/create-record.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/records/create** |
| :----------- | :------------------------------------------------------------------------------------ |
| **请求方法** | POST                                                                                  |
...
| records                | array[object] | 是           | 每个元素代表需要创建的一条记录                                                                                                                                                                                                                                                                                                   |
| ∟ fields_value              | array[string] | 是           | 符合各个字段规范的值，详见 [多维表格参数说明](/app-integration-dev/wps365/server/dbsheet/parameters-description)                                                                                                                                                                                                                                                                                                                         |
## 请求地址示例
...
```json
{
  ...
  "data": {
    "records": [
      {
        "fields": "{\"文本\":\"第一行文本\",\"日期\":\"2024/12/20\",\"等级\":0}",
        "id": "G"
      }
    ]
  }
