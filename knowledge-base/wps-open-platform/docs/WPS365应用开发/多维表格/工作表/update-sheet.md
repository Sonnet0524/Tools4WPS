---
title: Update Sheet
breadcrumb: WPS365应用开发 > 多维表格 > 工作表 > 更新工作表
source: raw_md/app-integration-dev/wps365/server/dbsheet/sheets/update-sheet.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/update**       |
| :----------- | :---------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                |
