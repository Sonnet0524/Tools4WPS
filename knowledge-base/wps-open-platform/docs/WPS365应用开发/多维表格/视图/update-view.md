---
title: Update View
breadcrumb: WPS365应用开发 > 多维表格 > 视图 > 更新视图
source: raw_md/app-integration-dev/wps365/server/dbsheet/views/update-view.md
---
...
| **请求地址** | **https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/views/{view_id}/update** |
| :----------- | :-------------------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                          |
...
```
[POST] https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/views/{view_id}/update
```
