---
title: Get Event Export Address
breadcrumb: WPS365应用开发 > 事件订阅 > 获取事件出口地址
source: raw_md/app-integration-dev/wps365/server/event-subscription/get_event_egress_ip.md
---
