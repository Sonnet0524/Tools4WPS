...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/airsheet/{file_id}/worksheets/{worksheet_id}/float_images/delete          |
...
<OpenapiRenderTable  dataSource='[{"key":"float_image_id","name":"float_image_id","deprecated":false,"type":"integer","required":"是","enum":[],"xEnum":[],"description":"<p>浮动图片ID</p>\n","children":[]}]' />
