...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/meeting_room_banned_users/delete          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 删除会议室黑名单用户，被移除用户将恢复使用被禁用功能 |
...
<OpenapiRenderTable  dataSource='[{"key":"user_id","name":"user_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>用户id，可以从查询会议室黑名单用户列表接口获取</p>\n","children":[]}]' />
