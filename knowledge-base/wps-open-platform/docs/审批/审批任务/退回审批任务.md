...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/workflow/approval_tasks/{id}/rollback          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 退回审批任务 |
...
<OpenapiRenderTable  dataSource='[{"key":"instance_id","name":"instance_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>所在实例id</p>\n","children":[]},{"key":"node_id","name":"node_id","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>退回的节点id,该节点状态必须为approved,目前只支持退回上一个节点</p>\n","children":[]},{"key":"operator","name":"operator","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>任务操作人</p>\n","children":[]},{"key":"reason","name":"reason","deprecated":false,"type":"string","required":"是","enum":[],"xEnum":[],"description":"<p>退回原因</p>\n","children":[]}]' />
