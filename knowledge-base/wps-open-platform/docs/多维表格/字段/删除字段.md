...
| **请求地址** | **https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/fields/delete** |
| :----------- | :----------------------------------------------------------------------------------- |
| **请求方法** | POST                                                                                 |
...
| **名称** | **参数类型**  | **是否必填** | **说明** |
| :------- | :------------ | :----------- | :------- |
| fields   | array[string] | 是           | 字段列表，详见[多维表格参数说明](/app-integration-dev/wps365/server/dbsheet/parameters-description)         |

## 请求地址示例

```
[POST] https://openapi.wps.cn/v7/coop/dbsheet/{file_id}/sheets/{sheet_id}/fields/delete
```
...
| msg           | string        | 响应信息                                                                                                      |
| data          | object        | 响应数据                                                                                                      |
| ∟ fields     | array[object] | 被删除字段信息                                                                                                |
| ∟ ∟ deleted | boolean       | 字段是否被删除                                                                                                |
| ∟ ∟ id      | string        | 字段 id                                                                                                       |
| more          | object        | 更多的错误信息                                                                                                |
