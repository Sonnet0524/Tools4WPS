...
| **请求地址** | **https://openapi.wps.cn/v7/chats/unread_count**                                                        |
| :----------- |:--------------------------------------------------------------------------------------------------------|
| **请求方法** | GET                                                                                                     |
| **签名方式** | [KSO-1](/app-integration-dev/wps365/server/api-description/signature-description) |
| **权限要求** | 查询和管理会话（用户授权） `kso.chat.readwrite`<br/>查询会话（用户授权） `kso.chat.read`                                       |
...
```
[GET] https://openapi.wps.cn/open/v7/chats/unread_count
```
