...
| 字段          | 值                  |
|--------------|---------------------|
| **<div style="white-space: nowrap;">请求地址</div>**  | https://openapi.wps.cn/v7/calendar_exchange_binds/{exchange_binding_id}/delete          |
| **<div style="white-space: nowrap;">HTTP 方法</div>** | `POST`    |
| **<div style="white-space: nowrap;">接口描述</div>**  | 解绑 Exchange 账户。使用接口用户授权须有超管权限 |
...
| 属性名 | 类型 | 是否必填 | 描述 | 可选值 |
|-------|------|------|-------|-------|
| <div style="white-space: nowrap;">exchange_binding_id</div> | `string` | 是 | Exchange 绑定的唯一标识 ID，可通过获取Exchange账户绑定信息接口获取 | - 
